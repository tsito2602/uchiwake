...
export type State = { bills: Bill[]; expenses: Expense[]; statements: CardStatement[]; entries: CardEntry[]; cards: SharedCard[]; rent_rules: RentRule[]; ai_enabled: boolean; demo_enabled: boolean; month: string };
